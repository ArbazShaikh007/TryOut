...
from base.apis.v1.admin.models import Admin,admin_login_required
...
class AdminRegisterResource(Resource):
    def post(self):
        ...
        token = generate_token(admin.id, os.getenv("ADMIN_SECRET_KEY"))
...
class AdminLoginResource(Resource):
    def post(self):
        ...
        is_valid, result, status = validate_schema(login_schema, data)
        if not is_valid:
            return result, status
